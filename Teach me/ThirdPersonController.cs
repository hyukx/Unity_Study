...
void UpdateSmoothedMovementDirection (){
	Vector3 cameraTransform= Camera.main.transform;
	...
	float targetDirection= h * right + v * forward;
...
void ApplyGravity (){
	...
	{
		// Apply gravity
		FIXME_VAR_TYPE jumpButton= Input.GetButton("Jump");
...
void Update (){
	...
	FIXME_VAR_TYPE movement= moveDirection * moveSpeed + Vector3 (0, verticalSpeed, 0) + inAirVelocity;
	...
	{
		FIXME_VAR_TYPE xzMove= movement;
		xzMove.y = 0;
